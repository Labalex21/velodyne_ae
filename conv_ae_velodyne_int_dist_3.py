...
# log file
log_filename = "../data/logs/log_ae_dist_int_3_" + dt.datetime.now().strftime("%Y%m%d_%H_%M_%S") + ".txt"
log_file = open(log_filename,"w")
log_file.write("start\n")
log_file.flush()

res_filename = "../data/results/ae_dist_int_3_" + dt.datetime.now().strftime("%Y%m%d_%H_%M_%S") + ".txt"
...
for i in range(1,fc_array.shape[0]):
    ...
    path_model = "../data/20180201/models/conv_ae_velodyne_int_dist_3_" + str(fc_size_array[i,0]) + "_" + str(fc_size_array[i,1]) + "_" + str(fc_size_array[i,2]) + "_" + str(number_of_fc) + "_" + str(number_of_conv) + ".ckpt"
    ...
    dir_export_20180201 = '../data/features/velodyne_20180201_dist_int_3_' + str(last_encoder_width) + '_' +  str(number_of_fc) + '_' +  str(number_of_conv) + '.json'
    ...
    dir_export_20180410_2 = '../data/features/velodyne_20180410_2_dist_int_3_' + str(last_encoder_width) + '_' +  str(number_of_fc) + '_' +  str(number_of_conv) + '.json'
    dir_data = '../data/20180410/scans_rot_2/'
    export_encoder(dir_data, dir_export_20180410_2, path_traj, last_encoder_width)

    dir_export_icsens = '../data/features/velodyne_icsens_dist_int_3_' + str(last_encoder_width) + '_' +  str(number_of_fc) + '_' +  str(number_of_conv) + '.json'
    ...
    dir_export_herrenhausen = '../data/features/velodyne_herrenhausen_dist_int_3_' + str(last_encoder_width) + '_' +  str(number_of_fc) + '_' +  str(number_of_conv) + '.json'
