...
for i in range(features_array.shape[0]):
    ...
    number_of_fc =1
    path_model = "../data/20180201/models/conv_ae_velodyne_features_" + str(fc_size_array[i,0]) + "_" + str(fc_size_array[i,1]) + "_" + str(fc_size_array[i,2]) + "_" + str(number_of_fc) + "_" + str(number_of_conv) + '_' +  str(patches_array[i]) + '_' +  str(features_array[i]) + ".ckpt"
    ...
    rand_value = tf.Variable(tf.random_uniform([], minval=0, maxval=10, dtype=tf.int32))
    ...
    dir_export_herrenhausen = '../data/features/velodyne_herrenhausen_features_' + str(last_encoder_width) + '_' +  str(number_of_fc) + '_' +  str(number_of_conv) + '_' +  str(patches_array[i]) + '_' +  str(features_array[i]) + '.json'
    ...
    dir_export_leinhausen = '../data/features/velodyne_leinhausen_features_' + str(last_encoder_width) + '_' +  str(number_of_fc) + '_' +  str(number_of_conv) + '_' +  str(patches_array[i]) + '_' +  str(features_array[i]) + '.json'
