...
def read_tfrecord(folder, image_shape, batch_size = 100, num_epochs = 100):
    ...
    images = tf.train.shuffle_batch([image], batch_size=batch_size, capacity=number_batches*batch_size*num_epochs, enqueue_many=True, allow_smaller_final_batch = True, min_after_dequeue=batch_size)
