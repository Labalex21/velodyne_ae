...
for i in range(2,fc_array.shape[0]):
    ...
    x, number_batches = fh.read_tfrecord(dir_records, image_shape, batch_size = batch_size,num_epochs=100)
    ...
    dir_export_herrenhausen = '../data/features/velodyne_herrenhausen_int_dist_' + str(last_encoder_width) + '_' +  str(number_of_fc) + '_' +  str(number_of_conv) + '.json'
