...
res_filename = "../data/results/ae_conv_" + dt.datetime.now().strftime("%Y%m%d_%H_%M_%S") + ".txt"
...
for i in range(1,fc_array.shape[0]):
    ...
    path_model = "../data/20180201/models/conv_ae_velodyne_conv_" + str(fc_size_array[i,0]) + "_" + str(fc_size_array[i,1]) + "_" + str(fc_size_array[i,2]) + "_" + str(number_of_fc) + "_" + str(number_of_conv) + ".ckpt"
